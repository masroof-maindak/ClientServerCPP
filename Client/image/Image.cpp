...
Image::Image(const char* filepath, int dataType)
    : img(cv::imread(filepath, dataType)) {} // Modified constructor

Image::Image(int numRows, int numCols, int dataType)
    : img(numRows, numCols, dataType) {} // Modified constructor
